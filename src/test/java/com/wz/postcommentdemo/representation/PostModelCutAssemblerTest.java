...
class PostModelCutAssemblerTest {

    @InjectMocks
    private PostModelCutAssembler underTest;
    ...
    public void testToCutModelConversion(){
        ...
        PostModelCut modelCut = underTest.toModel(post);
        ...
        assertThat(modelCut.getImagePath()).isEqualTo(uploadPath + "/" + post.getId() + "/thumbs/" + post.getImage());
    }
}